...
class EnrollmentControllerTest {
    ...
    void setUp() {
        ...
        Mockito.when(mapper.toDTO(enrollment_01)).thenReturn(enrollment_dto_01);
        Mockito.when(mapper.toDocument(enrollment_dto_01)).thenReturn(enrollment_01);
