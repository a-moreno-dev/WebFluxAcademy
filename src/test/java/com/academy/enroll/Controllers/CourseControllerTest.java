...
//
//        Mockito.when(mapper.map(course_01, CourseDTO.class)).thenReturn(course_dto_01);
//        Mockito.when(mapper.map(course_dto_01, CourseDocument.class)).thenReturn(course_01);
//        Mockito.when(mapper.map(course_02, CourseDTO.class)).thenReturn(course_dto_02);
//        Mockito.when(mapper.map(course_dto_02, CourseDocument.class)).thenReturn(course_02);
//
